 ...
 * the window's bounds.
 * @param  {object} imageDimensions [description]
 * @return {object} newDimensions [description]
 */
function centerImage(imageDimensions) {
    ...
    // console.log('W: ' + imageDimensions.width + ' H: ' + imageDimensions.height + '; New W: ' + newDimensions.width + ' New H: ' + newDimensions.height + '; path: ' + patht);
