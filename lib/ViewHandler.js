...
view.prototype.zoomImage = function () {
  try {
    ...
    if ((vs.title.percentShrunk < 100 /*|| !this.zoomed*/) && !APP_HOME) {
      ...
      vs.stateArray[vs.pointer.current].element.classList.remove(FIT_IMG_CLASS);
      vs.stateArray[vs.pointer.current].element.classList.add(FULL_IMG_CLASS);
    }
  } catch (e) {
...
view.prototype.fitImage = function () {
  try {
    ...
    if ((/*vs.title.percentShrunk < 100 ||*/ this.zoomed) && !APP_HOME) {
      ...
      // Set the CSS class that zooms the image
      vs.stateArray[vs.pointer.current].element.classList.remove(FULL_IMG_CLASS);
      vs.stateArray[vs.pointer.current].element.classList.add(FIT_IMG_CLASS);
    }
  } catch (e) {
...
function resetView() {
  ...
  vs.stateArray[0].element.classList.add(FIT_IMG_CLASS);
  vs.stateArray[1].element.classList.add(FIT_IMG_CLASS);
  vs.stateArray[2].element.classList.add(FIT_IMG_CLASS);

  vs.stateArray[0].element.classList.remove(FULL_IMG_CLASS);
  vs.stateArray[1].element.classList.remove(FULL_IMG_CLASS);
  vs.stateArray[2].element.classList.remove(FULL_IMG_CLASS);
